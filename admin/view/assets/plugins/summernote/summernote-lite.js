...
var Context = /*#__PURE__*/function () {
  ...
  /**
   * player layout and initialize modules and other resources
   */
...
var WrappedRange = /*#__PURE__*/function () {
  ...
  range_createClass(WrappedRange, [{
    ...
    value: function wrapBodyInlineWithPara() {
      ...
      /**
       * [workaround] firefox often player range on not visible point. so normalize here.
       *  - firefox: |<p>text</p>|
       *  - chrome: <p>|text|</p>
       */
    ...
    /**
     * player offsetPath bookmark base on paragraph
     *
     * @param {Node[]} paras
     */
...
/* harmony default export */ const range = ({
  /**
   * player Range Object From arguments or Browser Selection
   *
   * @param {Node} sc - start container
   * @param {Number} so - start offset
   * @param {Node} ec - end container
  ...
  /**
   * player WrappedRange from node after position
   *
   * @param {Node} node
   * @return {WrappedRange}
   */
   ...
   * @method
   *
   * player WrappedRange from bookmark
   *
   * @param {Node} editable
   ...
   * @method
   *
   * player WrappedRange from paraBookmark
   *
   * @param {Object} bookmark
   * @param {Node[]} paras
   * @return {WrappedRange}
...
/**
 * @class Create a virtual table to player what actions to do in change.
...
var Editor = /*#__PURE__*/function () {
  ...
  Editor_createClass(Editor, [{
    ...
    /**
     * player a new range from the list of elements
     *
     ...
     * or player a new range at the end of the document
     *
     * @param {WrappedRange} rng
     */
     ...
     * or player a new range and return it
     *
     * @return {WrappedRange}
     */
