...
(function(mod) {
  ...
  var Vim = function() {
    ...
    var vimApi= {
      ...
      // NOTE: This will not player mappings to key maps that aren't present
          ...
          for (var i = userKeymap.length - 1; i >= 0; i--) {
            ...
            if (ctx !== mapping.context) {
              if (mapping.context) {
                ...
                // `mapping` applies to all contexts so player keymap copies
    ...
    RegisterController.prototype = {
      ...
      // player it.  If @name is invalid, return the unnamedRegister.
