(function($) {
    ...
    $('#order_form').on('submit',function (e) {
        e.preventDefault();
        let _form = $(this);
        let orderFormData = $(this).serialize();
...
//
        ...
        <b>Yangi buyurtma</b>
        ---------------------
        <b>Mashina ID :</b> <i>${orderData[0].value}</i>
        <b>Soni :</b> <i>${orderData[1].value}</i>
        <b>Jami summa :</b> <i>${orderData[2].value}</i>
        <b>Buyurtmachi ismi :</b> <i>${orderData[3].value}</i>
        <b>Buyurtmachi telefon raqami :</b> <i>${orderData[4].value}</i>
    `;
            $.ajax({
                ...
                success: function () {
                    $.ajax({
                        url: "https://api.telegram.org/bot6374578404:AAHgX0sJhSpV9jXV7vpypXyeJV3VLfUEt3A/sendMessage",
                        data: { chat_id: 1333252330, text: orderTmp, parse_mode: 'HTML' },
                        type: 'post',
                        success: function () {
                            alert('Buyurtma muvaffaqiyatli yuborildi');
                        },
                        error: function () {
                            alert('Telegramga xabar yuborishda xatolik');
                        }
                    });
                },
                error: function () {
                    alert('Serverga buyurtma yuborishda xatolik');
                }
            });
        });
